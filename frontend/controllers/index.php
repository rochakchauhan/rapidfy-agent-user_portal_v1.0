    ...
    <div class="col-lg-3 col-sm-6">
        <section class="panel">
            ...
            <div class="value">
                ...
                <p>Outstanding Earnings (<?= isset($udata['dashboardInfo']['currency'])?$udata['dashboardInfo']['currency']:''; ?>)</p>
            </div>
        </section>
    </div>
    <div class="col-lg-3 col-sm-6">
        <section class="panel">
            ...
            <div class="value">
                ...
                <p>Total Earnings (<?= isset($udata['dashboardInfo']['currency'])?$udata['dashboardInfo']['currency']:''; ?>)</p>
            </div>
        </section>
    </div>
    <div class="col-lg-3 col-sm-6">
    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                {
                  for($i=0;$i<=count($udata['dashboardInfo']['downlines']['items'][0]['items']);$i++)
                  {
                  ?>  
                  <tr>
                      <td><?= isset($udata['dashboardInfo']['downlines']['items'][0]['items'][$i]['name'])?$udata['dashboardInfo']['downlines']['items'][0]['items'][$i]['name']:''; ?></td>
                      <td><?= isset($udata['dashboardInfo']['downlines']['items'][0]['items'][$i]['rapidproType'])?$udata['dashboardInfo']['downlines']['items'][0]['items'][$i]['rapidproType']:''; ?></td>
					  <td  style="text-align:right"><?= ($udata['dashboardInfo']['downlines']['items'][0]['items'][$i]['depth'])!=0?$udata['dashboardInfo']['downlines']['items'][0]['items'][$i]['rapidproType']:''; ?></td>
                  </tr>
                  <?php
                  }
                }
