...
class AccountmanagerController extends \yii\web\Controller {
    ...
    public function actionoAuthSuccess($client) {
        ...
        if (isset($userAttributes['kind'])) {
            ...
            curl_setopt($ch, CURLOPT_URL, "http://staging.api.rapidfy.com/v3/accountmanager/accounts/logingplus");
            ...
            curl_setopt($ch, CURLOPT_URL, "http://staging.api.rapidfy.com/v3/accountmanager/accounts/loginfacebook");
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
            curl_setopt($ch, CURLOPT_HEADER, FALSE);
    ...
    public function actionIndex() {
        ...
        if ($user_id) {
           ...
           $this->redirect(Yii::$app->urlManager->createUrl('accountmanager/login', [
                        'FBuserExist' => isset($_SESSION['FBuserExist']) ? $_SESSION['FBuserExist'] : Null,
            ]));
        }
    }
    ...
    public function Getuserdata($emailid, $password) {
        ...
        curl_setopt($ch, CURLOPT_URL, "http://staging.api.rapidfy.com/v3/accountmanager/accounts/loginemail");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
        curl_setopt($ch, CURLOPT_HEADER, FALSE);
    ...
    public function actionLogout() {
        ...
        curl_setopt($ch, CURLOPT_URL, "http://staging.api.rapidfy.com/v3/accountmanager/v1/accounts/$rapiduserid/logout");
        curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
        curl_setopt($ch, CURLOPT_HEADER, FALSE);
