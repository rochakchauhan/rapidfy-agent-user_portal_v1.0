      ...
      <!--header start-->
        ...
        <header class="header white-bg">
          <div class="navbar-header">
              ...
              <img src="http://www.rapidfy.com/images/rapidfy.png" style = "margin-left: -280px; padding-top: 10px;"></img>
                      <li class="active" style = "margin-left: 120px;"><a href="<?= Yii::getAlias('@web') ?>">Dashboard</a></li>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <?php $avtar=$baseUrl."/img/avatar1_small.jpg"; ?>
                            <img alt="" height="20px;" src="<?= isset($_SESSION['userdata']['avatarImage'])?$_SESSION['userdata']['avatarImage']:$avtar ?>">
                            <span class="username"><?= isset($_SESSION['userdata']['username'])?$_SESSION['userdata']['username']:'XYZ' ?></span>
                              <b class="caret"></b>
                        </a>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="active" href="../views/site/index.php">
