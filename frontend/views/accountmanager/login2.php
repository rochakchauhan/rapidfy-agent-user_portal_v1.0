...
?>
  <?php $loginUrl = Yii::$app->urlManager->createUrl('/accountmanager/login');
$form=ActiveForm::begin(['action' => $loginUrl,'id'=>'login-form']); ?>
    <div class="form-signin">
        ...
        <div class="login-wrap">
            ...
            <p>or you can sign in via social network here</p>
            <div class="login-social-link">
                <a href="index.php?r=site%2Fauth&authclient=facebook" class="facebook">
                    <i class="fa fa-facebook"></i>
                    Facebook

                </a>
                <a href="index.php?r=site%2Fauth&authclient=google" class="twitter">
