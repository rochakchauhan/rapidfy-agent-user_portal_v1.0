    ...
    <div class="row state-overview">
        <div class="col-lg-3 col-sm-6">
            <section class="panel">
                ...
                <div class="value">
                    <h1 class="coun">
    <?= isset($udata['dashboardInfo']['outstandingEarnings']) ? $udata['dashboardInfo']['outstandingEarnings'] : '0'; ?>
                    </h1>
                    <p>Total Commissions (<?= isset($udata['dashboardInfo']['currency']) ? $udata['dashboardInfo']['currency'] : ''; ?>)</p>
                </div>
            </section>
        </div>
        <div class="col-lg-3 col-sm-6">
            <section class="panel">
                ...
                <div class="value">
                    <h1 class=" coun">
    <?= isset($udata['dashboardInfo']['totalEarnings']) ? $udata['dashboardInfo']['totalEarnings'] : '0'; ?>
                    </h1>
                    <p>Total Incentive (<?= isset($udata['dashboardInfo']['currency']) ? $udata['dashboardInfo']['currency'] : ''; ?>)</p>
                </div>
            </section>
        </div>
        <div class="col-lg-3 col-sm-6">
            <section class="panel">
                ...
                <div class="value">
                    <h1 class=" coun">
    <?= isset($udata['dashboardInfo']['totalDownline']) ? $udata['dashboardInfo']['totalDownline'] : '0'; ?>
                    </h1>
                    <p>My Referral</p>
                </div>
            </section>
        ...
        <div class="col-lg-3 col-sm-6">
            <section class="panel">
                ...
                <div class="value">
                    <h1 class=" coun">
    <?= isset($udata['dashboardInfo']['newDownline']) ? $udata['dashboardInfo']['newDownline'] : ''; ?>
                    </h1>
                    <p>Group Referral</p>
                </div>
            </section>
        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <table class="table table-striped table-advance table-hover">
                    ...
                    <tbody>
    <?php
    if (isset($udata['dashboardInfo'])) {
        if (count($udata['dashboardInfo']['downlines']['items']) > 0) {
            for ($ii = 0; $ii < count($udata['dashboardInfo']['downlines']['items']); $ii++) {
                for ($i = 0; $i < count($udata['dashboardInfo']['downlines']['items'][$ii]['items']); $i++) {
                    ?>  
                                        <tr>
                                            <td><?= isset($udata['dashboardInfo']['downlines']['items'][$ii]['items'][$i]['name']) ? $udata['dashboardInfo']['downlines']['items'][$ii]['items'][$i]['name'] : ''; ?></td>
                                            <td><?= isset($udata['dashboardInfo']['downlines']['items'][$ii]['items'][$i]['rapidproType']) ? $udata['dashboardInfo']['downlines']['items'][$ii]['items'][$i]['rapidproType'] : ''; ?></td>
                                            <td  style="text-align:right"><?= isset($udata['dashboardInfo']['downlines']['items'][$ii]['items'][$i]['depth']) ? $udata['dashboardInfo']['downlines']['items'][$ii]['items'][$i]['depth'] : ''; ?></td>
                                        </tr>
                                        <?php
                                    }
                                }
            ...
            <section class="panel">
                <div class="panel-body">
                    <a href="#" class="task-thumb">
                        <img src="<?= $baseUrl ?>/img/avatar1.jpg" alt="">
                    </a>
                            ...
                            <div class="timeline-desk">
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <div class="album">
                                            <a href="#">
                                                <img alt="" src="<?= $baseUrl ?>/img/sm-img-1.jpg">
                                            </a>
                                            <a href="#">
                                                <img alt="" src="<?= $baseUrl ?>/img/sm-img-2.jpg">
                                            </a>
                                            <a href="#">
                                                <img alt="" src="<?= $baseUrl ?>/img/sm-img-3.jpg">
                                            </a>
                                            <a href="#">
                                                <img alt="" src="<?= $baseUrl ?>/img/sm-img-1.jpg">
                                            </a>
            ...
            <section class="panel post-wrap pro-box">
                ...
                <aside class="post-highlight yellow v-align">
                    <div class="panel-body text-center">
                        <div class="pro-thumb">
                            <img src="<?= $baseUrl ?>/img/ring.jpg" alt="">
                        </div>
                    </div>
                </aside>
            </section>
                        ...
                        <div class="follower">
                            <div class="panel-body">
                                ...
                                <div class="follow-ava">
                                    <img src="<?= $baseUrl ?>/img/follower-avatar.jpg" alt="">
                                </div>
                            </div>
                        </div>
